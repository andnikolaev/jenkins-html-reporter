...
import com.epam.htmlreporter.model.ProfileData;
import com.epam.htmlreporter.model.ProfileMetaData;
import com.epam.htmlreporter.model.Project;
import com.epam.htmlreporter.model.QualityProfile;
import com.epam.htmlreporter.model.Rule;
...
public class QualityProfileProvider extends AbstractDataProvider {
    ...
    public List<QualityProfile> getQualityProfiles(final String pOrganization)
        ...
        String request1 = String.format(getRequest(GET_QUALITY_PROFILES_REQUEST),
        ...
        for (ProfileMetaData profileMetaData : metaData) {
            ...
            // get configuration
            request1 = String.format(getRequest(GET_QUALITY_PROFILES_CONF_REQUEST),
                    getServer().getUrl(),
            ...
            final String xml = stringRequest(request1);
            ...
            while(goon) {
                // prepare the request
                request1 = String.format(getRequest(GET_QUALITY_PROFILES_RULES_REQUEST),
            ...
            request1 = String.format(getRequest(GET_QUALITY_PROFILES_PROJECTS_REQUEST),
